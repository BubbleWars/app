...
export const nodeEmitResource = (
    ...
    const emittedResourceVelocityMagnitude = (1 / emittedResource.body.getMass())*EMISSION_SPEED *0.1;
...
export const nodeEmitBubble = (
    ...
    const emittedBubbleVelocityMagnitude = (1 / emittedBubble.body.getMass())*EMISSION_SPEED *0.1;
