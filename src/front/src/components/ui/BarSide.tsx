...
export const AddressView = ({ id }: { id: string }) => {
    return <p className="bold color-blue">{truncateAddress(id)}</p>;
};
...
export const ResourcesIcon = ({
    ...
    return (
        <div className="flex items-center space-x-2">
            ...
            <div key="blue" className="flex items-center color-blue space-x-0">
                <p className="text-blue-600">0.00</p>
                <Cross1Icon
                    color="blue-600"
                    className="p-0 m-0 fill-blue-600 stroke-fill-blue-600 h-3 w-3"
                />
                <ShadowIcon
                    color="blue-600"
                    className="h-3 w-3 p-0 m-0 fill-blue-600 stroke-fill-blue-600"
                />
            </div>
            <div key="red" className="flex items-center color-red space-x-0">
                <p className="text-red-600">0.00</p>
                <Cross1Icon
                    color="red-600"
                    className="p-0 m-0 fill-red-600 stroke-fill-red-600 h-3 w-3"
                />
                <ShadowIcon
                    color="red-600"
                    className="h-3 w-3 p-0 m-0 fill-red-600 stroke-fill-red-600"
                />
            </div>
            <div
                key="green"
            ...
            >
                ...
                <Cross1Icon
                    color="green-600"
                    className="p-0 m-0 fill-green-600 stroke-fill-green-600 h-3 w-3"
                />
                <ShadowIcon
                    color="green-600"
                    className="h-3 w-3 p-0 m-0 fill-green-600 stroke-fill-green-600"
                />
            </div>
        </div>
    );
