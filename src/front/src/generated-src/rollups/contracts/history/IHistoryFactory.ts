...
export interface IHistoryFactoryInterface extends utils.Interface {
  functions: {
...
export interface IHistoryFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IHistoryFactoryInterface;
