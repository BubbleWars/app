...
export declare namespace History {
  export type ClaimStruct = {
    ...
    firstIndex: PromiseOrValue<BigNumberish>;
    lastIndex: PromiseOrValue<BigNumberish>;
  };
...
export interface HistoryInterface extends utils.Interface {
  ...
  events: {
    "NewClaimToHistory(address,tuple)": EventFragment;
...
export interface History extends BaseContract {
  ...
  filters: {
    "NewClaimToHistory(address,tuple)"(
