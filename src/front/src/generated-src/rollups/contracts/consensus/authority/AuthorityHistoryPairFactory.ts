...
export interface AuthorityHistoryPairFactoryInterface extends utils.Interface {
  functions: {
...
export interface AuthorityHistoryPairFactory extends BaseContract {
  ...
  functions: {
     ...
     */
    calculateAuthorityHistoryAddressPair(
      _authorityOwner: PromiseOrValue<string>,
  ...
  callStatic: {
    ...
    "newAuthorityHistoryPair(address)"(
      _authorityOwner: PromiseOrValue<string>,
      overrides?: CallOverrides
    ): Promise<[string, string] & { authority_: string; history_: string }>;
